				...
				<div id="<?php echo $theme->slug; ?>" class="theme">
					...
					<div class="theme-actions">
						<?php if( wp_get_theme( $theme->slug )->exists() ) { ?>
							...
							<img data-toggle="tooltip" title="<?php _e( 'Already installed', 'accesspresslite' ); ?>" data-placement="bottom" class="theme-exists" src="<?php echo $directory_uri ?>/inc/options-framework/images/tick.png"/>
							<!-- Activate Button -->
