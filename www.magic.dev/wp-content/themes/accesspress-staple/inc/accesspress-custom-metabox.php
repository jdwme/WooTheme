...
<tr>
<td colspan="4"><em class="f13"><?php _e('Choose Sidebar Template','accesspress-staple'); ?></em></td>
</tr>
...
<tr>
    <td><em class="f13"><?php printf( __('You can set up the sidebar content <a href="%s" target="_blank">here</a>','accesspress-staple'), admin_url('/themes.php?page=staple-options')) ?></em></td>
</tr>
</table>
